...
//个人信息部分配置
const AVATAR_FILENAME = "8d48290f850b7785090289224197fa96.jpg"; //头像配置，头像需要放进public文件夹内，这里只写文件名和后缀
//处理头像路径的函数(无需修改)
...
export const mail = "mailto:3261007243@qq.com"; //邮箱配置
export const github = "https://github.com/XJH"; //github网站配置
